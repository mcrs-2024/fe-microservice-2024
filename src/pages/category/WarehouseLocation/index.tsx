...
import ChapterModal from './WarehouseLocationModal';
...
const WarehouseLocation = () => {
  ...
  const [modalType, setModalType] = useState<WarehouseLocationModalType>('add');
  const [selectedRecord, setSelectedRecord] =
    useState<TWarehouseLocation | null>();
  ...
  const {
    ...
    onChangeFilter,
    onResetFilter,
  } = useFilter<TFilterWarehouseLocation>({
    defaultFilter: {
      icdTypeCode: '',
      icdChapterNameV: '',
    },
  ...
  const onChangeModalType = (type: WarehouseLocationModalType) => {
    setModalType(type);
  };
  ...
  const columns: ColumnsType<TWarehouseLocation> = [
    {
    ...
    },
    {
      ...
      align: 'center',
      fixed: 'right',
      render: (_, record: TWarehouseLocation) => {
        return (
          <Flex justify='center'>
            <ButtonCustom.Edit
              onClick={() => {
  ...
  return (
    <>
      ...
      <Space direction='vertical' className='d-flex'>
        ...
        <TableCustom
          columns={columns}
          title={t('Store_location_configuration')}
          extra={
            <>
              <ButtonCustom.Create
                type='primary'
